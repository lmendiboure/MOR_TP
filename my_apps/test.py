...
class SimpleSwitch13(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]   # On specifie la version d'openflow
    ...
    # Definition des caracteristiques du switch a l'init
    ...
    # Fonction permettant la mise en forme de la requete FlowMod
    # Dans cette fonction on ajoute le parametre hard timeout ! (3.2.2.3)
